...
window.location = \"enroll_faculty_form.php\"
	...
	$sql="insert into first_second_year_student_details values(DEFAULT,
	'".$student_rollnno."','".$student_lastname."','".$student_firstname."',
	'".$student_phone."','".$student_email."','".$student_program."',
	'".$student_specialization."','".$student_joining."','".$student_graduation."',
	'".$student_year."');";
