...
require "init.php";
	...
	$sql="SELECT token FROM device_details";
    ...
    $notification = array('title' =>$title , 'text' => $body, 'sound' => 'default', 'badge' => '1','click_action'=>'edu.thapar.CalendarNotification');
