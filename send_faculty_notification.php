...
require "init.php";
	...
	$sql="SELECT token FROM `login_success_device_details` WHERE `type`='faculty'";
    ...
    $notification = array('title' =>$title , 'text' => $body, 'sound' => 'default', 'badge' => '1','click_action'=>'edu.thapar.FacultyNotificationScreen');
