...
$query="select * from student_details where student_rollnno like '".$student_rollnno."';";
...
window.location = \"enroll_student_form.php\"
	...
	$sql="insert into student_details values(DEFAULT,'".$student_rollnno."','".$student_lastname."','".$student_firstname."','".$student_phone."','".$student_email."','".$student_program."','".$student_specialization."','".$student_joining."','".$student_graduation."','".$student_year."');";
