...
<html lang="en">
 <head>
  <meta charset="utf-8">
  <title>Enroll First Year Student</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="title" content="NEW India LMS APP">
  <meta name="description" content="Enroll First Year Student">
...
#logout_button{
 ...
 <body>    
    <br><br>
        <div class="container">
            <div class="row">
             <div class="col-md-12 text-center"><h1 class="main-header">New India LMS APP - First Year Enrollment</h1></div>
			...
			<br>
                ...
                <div class="col-md-6  col-sm-offset-3" id="form-login">
                    <form class="well" action="import_firstyear_student_csv.php" method="post" name="upload_excel" enctype="multipart/form-data">
                        <fieldset>
			...
			<div class="row">
             <div class="col-md-12 text-center"><h1>Student Enrollment</h1></div>
				...
				<br>
                    <form class="well" action="insert_firstyear_student_details.php" method="post" name="upload_studentdetails" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <div class="control-group">
							 ...
							 <div class="control-group">
                                ...
                                <div class="controls form-group">
                                    <input type="text" name="batch_number" id="batch_number" class="input-medium form-control">
                                </div>
                            </div>
                            <div class="control-group">
                                <div class="controls">
