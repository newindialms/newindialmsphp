...
$query= "select feedback_response,feedback_question,feedback_sent_date,feedback_sent_time from submitted_rate_feedback where (coursename like '".$coursename."'AND feedback_sent_date like '".$feedback_sent_date."'AND faculty_id like '".$faculty_id."');";
