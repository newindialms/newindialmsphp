...
$query= "SELECT course_schedule_from,course_schedule_to,course_schedule_duration course_schedule_day FROM course_schedule_issue WHERE (course_schedule_issue ='$course_schedule_issue' AND course_schedule_issue_semester='$course_schedule_issue_semester')";
