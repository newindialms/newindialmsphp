...
if($student_rollnno === NULL){
    ...
    $sql = "INSERT INTO first_year_attendance_details (student_rollnno, course_details_name, faculty_employeeid,attendance_date,attendance_time,attendance_status,group_name,section_name) values ( '$arr_str','$course_details_name','$faculty_employeeid','$attendance_date','$attendance_time','$attendance_status','$groupname','$sectionname');";
